...
class CodeForgeController implements DeltaTextInputClient {
  ...
  /// Initializes language-specific default suggestions.
  ///
  /// Registers default custom suggestions based on the current language,
  /// and always includes JINJA suggestions regardless of language.
  /// This is called automatically when the language is set.
  void initializeLanguageSpecificSuggestions() {
    ...
    suggestions.addAll(_getJinjaSuggestions());
    ...
    if (langName != null) {
      switch (langName) {
        case 'html':
          suggestions.addAll(_getHtmlSuggestions());
          break;
        case 'json':
          suggestions.addAll(_getJsonSuggestions());
          break;
        case 'sql':
          suggestions.addAll(_getSqlSuggestions());
          break;
        case 'dart':
          suggestions.addAll(_getDartSuggestions());
          break;
        case 'python':
          suggestions.addAll(_getPythonSuggestions());
          break;
        case 'javascript':
        case 'typescript':
          suggestions.addAll(_getJavaScriptSuggestions());
          break;
        case 'css':
          suggestions.addAll(_getCssSuggestions());
          break;
        case 'markdown':
          suggestions.addAll(_getMarkdownSuggestions());
          break;
        case 'yaml':
          suggestions.addAll(_getYamlSuggestions());
          break;
        case 'xml':
          suggestions.addAll(_getXmlSuggestions());
          break;
        case 'bash':
        case 'shell':
          suggestions.addAll(_getShellSuggestions());
          break;
        case 'c':
        case 'cpp':
          suggestions.addAll(_getCppSuggestions());
          break;
        case 'java':
          suggestions.addAll(_getJavaSuggestions());
          break;
        case 'go':
          suggestions.addAll(_getGoSuggestions());
          break;
        case 'rust':
          suggestions.addAll(_getRustSuggestions());
          break;
        case 'php':
          suggestions.addAll(_getPhpSuggestions());
          break;
        case 'ruby':
          suggestions.addAll(_getRubySuggestions());
          break;
        case 'swift':
          suggestions.addAll(_getSwiftSuggestions());
          break;
        case 'kotlin':
          suggestions.addAll(_getKotlinSuggestions());
          break;
        case 'csharp':
          suggestions.addAll(_getCsharpSuggestions());
          break;
        default:
  ...
  List<SuggestionModel> _getJinjaSuggestions() {
    return [
      SuggestionModel(
        label: 'If Statement',
        description: 'Insert a Jinja if statement block',
        replacedOnClick: '{% if condition %}\n  \n{% endif %}',
        triggeredAt: '{%',
      ),
      SuggestionModel(
        label: 'For Loop',
        description: 'Insert a Jinja for loop block',
        replacedOnClick: '{% for item in items %}\n  \n{% endfor %}',
        triggeredAt: '{%',
      ),
      SuggestionModel(
        label: 'Block',
        description: 'Insert a Jinja block definition',
        replacedOnClick: '{% block block_name %}\n  \n{% endblock %}',
        triggeredAt: '{%',
      ),
      SuggestionModel(
        label: 'Extends',
        description: 'Extend a Jinja template',
        replacedOnClick: '{% extends "base.html" %}',
        triggeredAt: '{%',
      ),
      SuggestionModel(
        label: 'Include',
        description: 'Include another Jinja template',
        replacedOnClick: '{% include "template.html" %}',
        triggeredAt: '{%',
      ),
      SuggestionModel(
        label: 'Comment',
        description: 'Insert a Jinja comment',
  ...
  List<SuggestionModel> _getHtmlSuggestions() {
    return [
      SuggestionModel(
        label: 'Div',
      ...
      SuggestionModel(
        label: 'Span',
        description: 'Insert a span element',
        replacedOnClick: '<span></span>',
        triggeredAt: '<',
      ),
      SuggestionModel(
        label: 'Link',
        description: 'Insert an anchor link',
  ...
  List<SuggestionModel> _getJsonSuggestions() {
    return [
      SuggestionModel(
        label: 'Object',
  ...
  List<SuggestionModel> _getSqlSuggestions() {
    return [
      SuggestionModel(
        label: 'SELECT',
  ...
  List<SuggestionModel> _getDartSuggestions() {
    return [
      SuggestionModel(
        label: 'Function',
  ...
  List<SuggestionModel> _getPythonSuggestions() {
    return [
      SuggestionModel(
        label: 'Function',
  ...
  List<SuggestionModel> _getJavaScriptSuggestions() {
    return [
      SuggestionModel(
        label: 'Function',
  ...
  List<SuggestionModel> _getCssSuggestions() {
    return [
      SuggestionModel(
  ...
  List<SuggestionModel> _getMarkdownSuggestions() {
    return [
      SuggestionModel(
        label: 'Heading 1',
  ...
  List<SuggestionModel> _getYamlSuggestions() {
    return [
      SuggestionModel(
      ...
      SuggestionModel(
        ...
        description: 'Insert a multi-line YAML string',
        replacedOnClick: 'key: |\n  line 1\n  line 2',
        triggeredAt: '|',
      ),
    ];
  ...
  List<SuggestionModel> _getXmlSuggestions() {
    return [
      SuggestionModel(
        label: 'Element',
  ...
  List<SuggestionModel> _getShellSuggestions() {
    return [
      SuggestionModel(
        label: 'If Statement',
  ...
  List<SuggestionModel> _getCppSuggestions() {
    return [
      SuggestionModel(
        label: 'Function',
  ...
  List<SuggestionModel> _getJavaSuggestions() {
    return [
      SuggestionModel(
        label: 'Class',
  ...
  List<SuggestionModel> _getGoSuggestions() {
    return [
      SuggestionModel(
        label: 'Function',
  ...
  List<SuggestionModel> _getRustSuggestions() {
    return [
      SuggestionModel(
        label: 'Function',
  ...
  List<SuggestionModel> _getPhpSuggestions() {
    return [
      SuggestionModel(
        label: 'Function',
  ...
  List<SuggestionModel> _getRubySuggestions() {
    return [
      SuggestionModel(
        label: 'Method',
  ...
  List<SuggestionModel> _getSwiftSuggestions() {
    return [
      SuggestionModel(
        label: 'Function',
  ...
  List<SuggestionModel> _getKotlinSuggestions() {
    return [
      SuggestionModel(
        label: 'Function',
  ...
  List<SuggestionModel> _getCsharpSuggestions() {
    return [
      SuggestionModel(
        label: 'Class',
        description: 'Insert a C# class',
